...
import { WarningOutlined, EnvironmentOutlined, UserOutlined } from '@ant-design/icons';
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div className='p-6' variants={modalVariants} initial='hidden' animate='visible' exit='exit'>
                        ...
                        <div className='mb-6 flex items-center rounded-lg border-l-4 border-yellow-500 bg-yellow-50 p-4 shadow-md'>
                            <WarningOutlined className='mr-3 text-xl text-yellow-600' />
                            <p className='text-sm font-medium text-yellow-800'>
                                Vui lòng kiểm tra kỹ thông tin đơn hàng trước khi xác nhận. Sau khi giao dịch, bạn sẽ
                                không thể thay đổi!
                            </p>
                        </div>
